...
urlpatterns = [
    ...
    path('search_recipes/', views.RecipeSearchView.as_view(),
         name='search_recipes'),
    ...
    path('<slug:slug>/edit_recipe/', views.EditRecipeView.as_view(),
         name='edit_recipe'),
    path('<slug:slug>/delete_recipe/', views.DeleteRecipeView.as_view(),
         name='delete_recipe'),
]
